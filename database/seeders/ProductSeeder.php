    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan PDUK Pimpinan (Rp 2.500.000). Saya ingin konsultasi ukuran dan detail pemesanan.',
                'is_featured' => true,
                'sort_order' => 1,
            ],
            [
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan PDU Kejaksaan Pria (Rp 2.000.000). Mohon info pemesanan.',
                'is_featured' => true,
                'sort_order' => 2,
            ],
            [
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan PDUK Jaksa Perempuan (Rp 2.200.000). Mohon info pemesanan.',
                'is_featured' => true,
                'sort_order' => 3,
            ],
            [
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan PDUB Jaksa Perempuan (Rp 2.000.000). Mohon info pemesanan.',
                'is_featured' => true,
                'sort_order' => 4,
            ],
            [
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan Baju Dinas Lapangan/PDL (Rp 1.500.000). Mohon info pemesanan.',
                'sort_order' => 5,
            ],
            [
                'category_id' => $dinasId,
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan Kemeja Dinas/PDH (Rp 800.000). Mohon info pemesanan.',
                'sort_order' => 6,
            ],
            ...
            [
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan Jas Formal Custom pria (Rp 2.800.000). Saya ingin konsultasi desain dan ukuran.',
                'sort_order' => 1,
            ],
            [
                'category_id' => $menId,
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan Kemeja Formal pria (Rp 800.000). Mohon info pemesanan.',
                'sort_order' => 2,
            ],
            [
                'category_id' => $menId,
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan One Set Formal pria (Rp 3.500.000). Saya ingin konsultasi paket lengkap.',
                'sort_order' => 3,
            ],
            [
                'category_id' => $menId,
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan Celana Formal pria (Rp 600.000). Mohon info pemesanan.',
                'sort_order' => 4,
            ],
            [
                'category_id' => $menId,
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan Tactical Uniform (Rp 1.500.000). Mohon info pemesanan.',
                'sort_order' => 5,
            ],
            ...
            [
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan Blazer Wanita (Rp 2.500.000). Saya ingin konsultasi desain dan ukuran.',
                'sort_order' => 1,
            ],
            [
                'category_id' => $womenId,
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan Jas Wanita Custom (Rp 2.800.000). Saya ingin konsultasi desain.',
                'sort_order' => 2,
            ],
            [
                'category_id' => $womenId,
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan Kebaya Modern (Rp 2.000.000). Mohon info pemesanan.',
                'sort_order' => 3,
            ],
            [
                'category_id' => $womenId,
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan Dress Formal (Rp 1.800.000). Mohon info pemesanan.',
                'sort_order' => 4,
            ],
            [
                'category_id' => $womenId,
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan Women Professional Set (Rp 3.000.000). Saya ingin konsultasi paket lengkap.',
                'sort_order' => 5,
            ],
            [
                'category_id' => $womenId,
                ...
                'features' => ['Custom ukuran', 'Bahan premium', 'Cutting modern', 'Nyaman dipakai seharian'],
                'whatsapp_text' => 'Halo Savana Taylor, saya tertarik dengan Rok/Celana Formal wanita (Rp 700.000). Mohon info pemesanan.',
                'sort_order' => 6,
            ],
            ...
            [
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya ingin custom jas premium (Mulai Rp 2.500.000). Saya ingin konsultasi desain dan bahan.',
                'sort_order' => 1,
            ],
            [
                'category_id' => $customId,
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya ingin custom baju dinas (Mulai Rp 1.500.000). Saya ingin konsultasi kebutuhan seragam instansi saya.',
                'sort_order' => 2,
            ],
            [
                'category_id' => $customId,
                ...
                'whatsapp_text' => 'Halo Savana Taylor, saya ingin custom kebaya (Mulai Rp 2.000.000). Saya ingin konsultasi desain kebaya impian saya.',
                'sort_order' => 3,
            ],
        ];
